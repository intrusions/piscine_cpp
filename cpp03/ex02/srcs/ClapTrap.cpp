...
/*   Updated: 2023/02/08 09:20:35 by jucheval         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ClapTrap::setHitPoints(uint32_t v) { _hitPoints = v; }

void		ClapTrap::setEnergyPoints(uint32_t v) { _energyPoints = v; }

void		ClapTrap::setAttackDamage(uint32_t v) { _attackDamage = v; }
